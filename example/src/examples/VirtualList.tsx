...
export function VirtualListExample() {
  ...
  const handleJump = async () => {
    ...
    try {
      // Use auto-load: will load more items if needed before scrolling
  ...
  return (
    <div className="example">
      <div className="example-header">
        ...
        <p>
          Only renders visible items. Loaded: <strong>{loadedCount}</strong> / 10,000
        </p>
      ...
      <div className="list-container virtual-container">
        <InfiniteList
          ref={listRef}
          fetcher={async ({ page, limit }) => {
            console.log(`Fetching page ${page} (virtual)`)
        ...
        >
          {(item: Item, index: number) => (
            <div className="item-card virtual-card">
